...
department = st.selectbox("Jurusan", [
...
categorical_cols = ['Gender', 'Income', 'Hometown', 'Attendance', 'Department']

# 👉 Misalnya kamu punya file encoder hasil dari pelatihan (disarankan)
# tapi kalau tidak ada, kita bisa definisikan secara manual seperti di bawah:
label_encoders = {}

for col in categorical_cols:
    le = LabelEncoder()
    # Simulasi fitting manual (harus sesuai dengan data training kamu)
    le.fit(input_data[col].unique())
